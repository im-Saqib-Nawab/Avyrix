...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 z-40 flex w-full max-w-[100vw] items-center justify-around border-t border-white/5 bg-section px-1 pb-[env(safe-area-inset-bottom)] pt-2 min-h-[56px] md:hidden">
      {MOBILE_TABS.map((tab) => {
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive ? 'text-accent-indigo' : 'text-muted'
            )}
          >
